...
def fetch_user_seen_movies(
    ...
    seen_movies = get_user_movies_by_status(user.id, db, "seen")
...
def fetch_user_later_movies(
    ...
    later_movies = get_user_movies_by_status(user.id, db, "later")
...
def fetch_user_not_interested_movies(
    ...
    not_interested_movies = get_user_movies_by_status(user.id, db, "not_interested")
